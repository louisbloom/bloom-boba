 ...
 * - Reusable for both libvterm control (GUI mode) and future custom TUI
 * rendering
 * - Helper functions for parameterized sequences (cursor positioning, scroll
 * regions)
 * - Uses standard VT100/ANSI reference names (CUP, DECSC, DECRC, ED, EL, SGR,
 * etc.)
 */
...
#define SGR_STRIKETHROUGH_OFF \
    CSI "29" SGR_FINAL /* SGR 29 - Not strikethrough */

/* SGR RGB color prefixes (for use with ansi_format_fg/bg_color_rgb) */
#define SGR_FG_RGB_PREFIX \
    "38;2;" /* SGR 38;2;r;g;b - Set foreground RGB color */
#define SGR_BG_RGB_PREFIX \
    "48;2;" /* SGR 48;2;r;g;b - Set background RGB color */
...
/* SGR color reset */
#define SGR_COLOR_RESET \
    CSI "39;49" SGR_FINAL /* SGR 39;49 - Reset both fg and bg */
